---
published: false
title: "Flashing your Dell PERC H310 to IT firmware (UEFI) :see_no_evil: :hear_no_evil:"
excerpt: "A unique line of text to describe this post that will display in an archive listing and meta description with SEO benefits."
date: 2015-03-15T00:00:00-04:00
tags:
  - Dell
  - firmware
  - storage
...
<figure style="width: 293px"  class="align-right">
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/perc_1.jpeg" alt="">
  <figcaption>Dell Perc H310 card</figcaption>
</figure>
...
`PowerEdge Expandable RAID Controller BIOS`{:.sh}
`PowerEdge Expandable RAID Controller BIOS`{:.bash}
`PowerEdge Expandable RAID Controller BIOS`{:.language-sh}
`PowerEdge Expandable RAID Controller BIOS`{:.language-bash}
...
The first thing we'll input is `MegaRec -adpList`{: .bash}.
...
```bashMegaRec -readsbr 0 backup.sbr```
...
Now we can flash our "empty" card with the Dell firmware:  
```bash
